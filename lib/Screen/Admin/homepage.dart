              ...
              child: Row(
                ...
                children: [
                  Text(
                    'App User',
                    style:
                        GoogleFonts.righteous(fontSize: 18, color: primaryColor),
                  ),
                  TextButton(
                    onPressed: () {
                    },
                    child: Text(
                      'View All',
                      style:
                          GoogleFonts.ubuntu(fontSize: 15, color: secondaryColor),
                    ),
                  ),
                ],
              ),
                    ...
                    Row(
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                              border: Border.all(
                                  style: BorderStyle.solid, width: 2,color: primaryColor),
                              borderRadius: BorderRadius.circular(50)),
                          child: ClipRRect(
                            borderRadius: BorderRadius.circular(50),
                            child: Image.network(
